...
=== "PAPI"
    ...
    **Query Account Data**
    ...
    try {
        ...
        console.log("\nBalance Details:");
        console.log("================");
        console.log(`Free Balance: ${accountInfo.data.free} (${Number(accountInfo.data.free) / 10_000_000_000} PAS)`);
        console.log(`Reserved Balance: ${accountInfo.data.reserved} (${Number(accountInfo.data.reserved) / 10_000_000_000} PAS)`);
        console.log(`Frozen Balance: ${accountInfo.data.frozen} (${Number(accountInfo.data.frozen) / 10_000_000_000} PAS)`);
        
        const total = Number(accountInfo.data.free) + Number(accountInfo.data.reserved);
        console.log(`\nTotal Balance: ${total} (${total / 10_000_000_000} PAS)`);
...
=== "Polkadot.js"
    ...
    **Query Account Data**
    ...
    async function main() {
      ...
      console.log("\nBalance Details:");
      console.log("================");
      console.log(`Free Balance: ${accountInfo.data.free.toString()} (${Number(accountInfo.data.free.toBigInt()) / 10_000_000_000} PAS)`);
      console.log(`Reserved Balance: ${accountInfo.data.reserved.toString()} (${Number(accountInfo.data.reserved.toBigInt()) / 10_000_000_000} PAS)`);
      console.log(`Frozen Balance: ${accountInfo.data.frozen.toString()} (${Number(accountInfo.data.frozen.toBigInt()) / 10_000_000_000} PAS)`);
...
=== "Dedot"
    ...
    **Query Account Data**
    ...
    async function main() {
      ...
      console.log("\nBalance Details:");
      console.log("================");
      console.log(`Free Balance: ${accountInfo.data.free} (${Number(accountInfo.data.free) / 1_000_000_000_000} DOT)`);
      console.log(`Reserved Balance: ${accountInfo.data.reserved} (${Number(accountInfo.data.reserved) / 1_000_000_000_000} DOT)`);
      console.log(`Frozen Balance: ${accountInfo.data.frozen} (${Number(accountInfo.data.frozen) / 1_000_000_000_000} DOT)`);
      
      const total = Number(accountInfo.data.free) + Number(accountInfo.data.reserved);
      console.log(`\nTotal Balance: ${total} (${total / 1_000_000_000_000} DOT)`);
...
=== "Python"
    ...
    **Query Account Data**
    ...
    def main():
        ...
        print(f"Free Balance: {free_balance} ({free_balance / 10_000_000_000} PAS)")
        print(
            f"Reserved Balance: {reserved_balance} ({reserved_balance / 10_000_000_000} PAS)"
        )
        print(f"Frozen Balance: {frozen_balance} ({frozen_balance / 10_000_000_000} PAS)")
    ...
    async fn main() -> Result<(), Box<dyn std::error::Error>> {
        ...
        if let Some(info) = account_info {
            ...
            println!(
                "Free Balance: {} ({} PAS)",
                info.data.free,
                info.data.free as f64 / 10_000_000_000.0
            );
            println!(
                "Reserved Balance: {} ({} PAS)",
                info.data.reserved,
                info.data.reserved as f64 / 10_000_000_000.0
            );
            println!(
                "Frozen Balance: {} ({} PAS)",
                info.data.frozen,
                info.data.frozen as f64 / 10_000_000_000.0
            );
