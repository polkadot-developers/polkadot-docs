...
```json
--8<-- 'code/reference/parachains/chain-data/metadata-format.json'
```
...
```json
--8<-- 'code/reference/parachains/chain-data/sudo-metadata.json'
```
...
```json
--8<-- 'code/reference/parachains/chain-data/sudo-metadata-calls.json'
```
...
```json
--8<-- 'code/reference/parachains/chain-data/extrinsic-metadata.json'
```
