...
function StorageDemo() {
    ...
    const [preferences, setPreferences, { loading: prefsLoading, error: prefsError }] =
    ...
    return (
        <div>
            ...
            <p>Theme: {prefsLoading ? "loading…" : (preferences?.theme ?? "not set")}</p>
            <button
                onClick={() => setPreferences({ theme: "dark", language: "en" })}
            >
                Set preferences
            </button>
