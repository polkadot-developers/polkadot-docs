...
- **Snippet includes**: Reusable code lives in `docs/.snippets/code/` and is included via `--8<-- 'code/path/to/file.ext'`. Do not inline code that already exists as a snippet.
