...
```bash
npm install --save @paraspell/sdk@{{dependencies.javascript_packages.paraspell_sdk.version}} polkadot-api@{{dependencies.javascript_packages.polkadot_api.version}} @polkadot-labs/hdkd-helpers@0.0.26 @polkadot-labs/hdkd@0.0.25
```
