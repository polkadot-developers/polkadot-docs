...
2.  Configure the dependencies required for FRAME pallet development in the `Cargo.toml` file as follows:
    ...
    ```toml
    --8<-- 'code/develop/blockchains/custom-blockchains/make-custom-pallets/Cargo.toml'
    ```
...
3.  Initialize the pallet structure by replacing the contents of `src/lib.rs` with the following scaffold code:
    ...
    ```rust
    --8<-- 'code/develop/blockchains/custom-blockchains/make-custom-pallets/barebone-pallet-template.rs'
    ```
...
```rust
--8<-- 'code/develop/blockchains/custom-blockchains/make-custom-pallets/pallet-config.rs'
```
...
```rust
--8<-- 'code/develop/blockchains/custom-blockchains/make-custom-pallets/pallet-event.rs'
```
...
```rust
--8<-- 'code/develop/blockchains/custom-blockchains/make-custom-pallets/pallet-error.rs'
```
...
```rust
--8<-- 'code/develop/blockchains/custom-blockchains/make-custom-pallets/pallet-storage.rs'
```
...
```rust
--8<-- 'code/develop/blockchains/custom-blockchains/make-custom-pallets/pallet-call.rs'
```
...
???code
    ```rust
    --8<-- 'code/develop/blockchains/custom-blockchains/make-custom-pallets/full-pallet.rs'
    ```
