...
```rust
--8<-- 'code/develop/rollups/customize-rollup/add-existing-pallets/pallet-basic-config-trait.rs'
```
...
```rust
--8<-- 'code/develop/rollups/customize-rollup/add-existing-pallets/utility-pallet-config-trait.rs'
```
...
```rust
--8<-- 'code/develop/rollups/customize-rollup/add-existing-pallets/parameter-types-example.rs'
```
...
```rust
--8<-- 'code/develop/rollups/customize-rollup/add-existing-pallets/impl-pallet-example-in-runtime.rs'
```
...
```rust
--8<-- 'code/develop/rollups/customize-rollup/add-existing-pallets/frame-support-runtime-macro.rs'
```
...
-   <span class="badge guide">Guide</span> __Make a Custom Pallet__
    ...
    [:octicons-arrow-right-24: Reference](/develop/rollups/customize-rollup/make-custom-pallet/)
