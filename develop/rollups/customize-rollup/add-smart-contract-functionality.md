...
For step-by-step guidance on adding these pallets to your runtime, refer to [Add a Pallet to the Runtime](/develop/rollups/customize-rollup/add-existing-pallets/){target=\_blank}.
...
This pallet enables the deployment and execution of Wasm-based smart contracts on your blockchain. For detailed instructions on adding this pallet to your runtime, see [Add a Pallet to the Runtime](/develop/rollups/customize-rollup/add-existing-pallets/){target=\_blank}.
...
-   <span class="badge guide">Guide</span> __Smart Contracts Overview__
    ...
    Learn how developers can build smart contracts on Polkadot by leveraging either Wasm/ink! or EVM contracts across many rollups.
...
-   <span class="badge guide">Guide</span> __EVM Contracts__
    ...
    Learn how Polkadot rollups such as Moonbeam, Astar, Acala, and Manta leverage the Ethereum Virtual Machine (EVM) and integrate it into their rollups.
