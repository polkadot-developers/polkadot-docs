...
![](/images/develop/rollups/customize-rollup/overview/frame-overview-1.webp)
...
```rust
--8<-- 'code/develop/rollups/customize-rollup/overview/pallet-skeleton.rs'
```
...
![](/images/develop/rollups/customize-rollup/overview/frame-overview-2.webp)
...
Using pre-built templates is an efficient way to begin building a custom blockchain. Templates provide a foundational setup with pre-configured modules, letting developers avoid starting from scratch and instead focus on customization. Depending on your project’s goals—whether you want a simple test chain, a standalone chain, or a rollup that integrates with Polkadot’s relay chains—there are templates designed to suit different levels of complexity and scalability.
...
- [**`rollup-template`**](https://github.com/paritytech/polkadot-sdk/tree/master/templates/parachain){target=\_blank} - designed for connecting to relay chains like Polkadot, Kusama, or Paseo, this template enables a chain to operate as a rollup. For projects aiming to integrate with Polkadot’s ecosystem, this template offers a great starting point
...
- [Add a Pallet to Your Runtime](/develop/rollups/customize-rollup/add-existing-pallets/)
- [Create a Custom Pallet](/develop/rollups/customize-rollup/make-custom-pallet/)