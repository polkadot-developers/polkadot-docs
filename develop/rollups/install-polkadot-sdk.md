...
3. Verify Homebrew has been successfully installed by running the following command:
    ...
    --8<-- 'code/develop/rollups/get-started/install-polkadot-sdk/termynal-1.html'
...
--8<-- 'code/develop/rollups/get-started/install-polkadot-sdk/termynal-2.html'

## Where to Go Next

- [Rollup Zero to Hero Tutorials](/tutorials/polkadot-sdk/rollups/zero-to-hero/){target=\_blank} - a series of step-by-step guides to building, testing, and deploying custom pallets and runtimes using the Polkadot SDK
