...
```rust
--8<-- 'code/develop/rollups/testing/mock-runtime/integration-testing-module.rs'
```
...
```rust
--8<-- 'code/develop/rollups/testing/mock-runtime/mock-runtime.rs'
```
### Genesis Storage
...
```rust
--8<-- 'code/develop/rollups/testing/mock-runtime/genesis-config.rs'
```
...
```rust
--8<-- 'code/develop/rollups/testing/mock-runtime/genesis-config-custom.rs'
```
...
```rust
--8<-- 'code/develop/rollups/testing/mock-runtime/pallets-configurations.rs'
```
...
-   <span class="badge guide">Guide</span> __Pallet Testing__
    ...
    [:octicons-arrow-right-24: Reference](/develop/rollups/testing/pallet-testing/)
