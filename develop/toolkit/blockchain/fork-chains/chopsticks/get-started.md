...
- **dev_newBlock** (newBlockParams) — generates one or more new blocks
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-chains/chopsticks/get-started/dev-newblock-example.js'
        ```
...
- **dev_setBlockBuildMode** (buildBlockMode) — sets block build mode
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-chains/chopsticks/get-started/dev-setBlockBuildMode-example.js'
        ```
...
- **dev_setHead** (hashOrNumber) — sets the head of the blockchain to a specific hash or number
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-chains/chopsticks/get-started/dev-setHead-example.js'
        ```
...
- **dev_setRuntimeLogLevel** (runtimeLogLevel) — sets the runtime log level
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-chains/chopsticks/get-started/dev-setRuntimeLogLevel-example.js'
        ```
...
- **dev_setStorage** (values, blockHash) — creates or overwrites the value of any storage
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-chains/chopsticks/get-started/dev-setStorage-example.js'
        ```
...
- **dev_timeTravel** (date) — sets the timestamp of the block to a specific date"
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-chains/chopsticks/get-started/dev-timeTravel-example.js'
        ```
