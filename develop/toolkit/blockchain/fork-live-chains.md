---
title: Fork Live Chains with Chopsticks
description: Learn how to use Chopsticks to install, configure, and use Polkadot SDK-based blockchains locally for a streamlined development process.
---
...
[Chopsticks](https://github.com/AcalaNetwork/chopsticks/){target=\_blank}, created and maintained by the [Acala Foundation](https://github.com/AcalaNetwork){target=\_blank}, is a powerful tool designed to enhance the development process for Polkadot SDK-based blockchains. It offers developers a user-friendly method to locally fork existing chains, enabling them to:
...
--8<-- 'code/develop/toolkit/blockchain/fork-live-chains/run-chopsticks-01.html'
...
-8<-- 'code/develop/toolkit/blockchain/fork-live-chains/polkadot-fork-01.html'
...
1. Select the network icon in the top left corner
    ...
    ![Network icon](/images/develop/toolkit/blockchain/fork-lives-chains/chopsticks-1.webp)
...
![](/images/develop/toolkit/blockchain/fork-lives-chains/chopsticks-2.webp)
...
```js
--8<-- 'code/develop/toolkit/blockchain/fork-live-chains/basic-example.js'
```
...
??? code "Output file content"
    ...
    ```json
    --8<-- 'code/develop/toolkit/blockchain/fork-live-chains/replay-block.json'
    ```
...
--8<-- 'code/develop/toolkit/blockchain/fork-live-chains/fork-output.html'
...
??? interface "**dev_newBlock** (newBlockParams) — Generates one or more new blocks"
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-live-chains/dev-newblock-example.js'
        ```

??? interface "**dev_setBlockBuildMode** (buildBlockMode) — Sets block build mode"
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-live-chains/dev-setBlockBuildMode-example.js'
        ```

??? interface "**dev_setHead** (hashOrNumber) — Sets the head of the blockchain to a specific hash or number"
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-live-chains/dev-setHead-example.js'
        ```

??? interface "**dev_setRuntimeLogLevel** (runtimeLogLevel) — Sets the runtime log level"
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-live-chains/dev-setRuntimeLogLevel-example.js'
        ```

??? interface "**dev_setStorage** (values, blockHash) — Creates or overwrites the value of any storage"
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-live-chains/dev-setStorage-example.js'
        ```

??? interface "**dev_timeTravel** (date) — Sets the timestamp of the block to a specific date"
    ...
    === "Example"
        ...
        ```js
        --8<-- 'code/develop/toolkit/blockchain/fork-live-chains/dev-timeTravel-example.js'
        ```