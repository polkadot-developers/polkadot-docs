...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/base-example.toml'
    ```

=== "JSON"

    ```json title="base-example.json"
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/base-example.json'
    ```
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/relaychain-example-nodes.toml'
    ```

=== "JSON"

    ```json title="relaychain-example-nodes.json"
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/relaychain-example-nodes.json'
    ```
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/relaychain-example-node-groups.toml'
    ```

=== "JSON"

    ```json title="relaychain-example-node-groups.json"
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/relaychain-example-node-groups.json'
    ```
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/parachain-example.toml'
    ```

=== "JSON"

    ```json title="parachain-example.json"
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/parachain-example.json'
    ```
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/collator-example.toml'
    ```

=== "JSON"

    ```json title="collator-example.json"
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/collator-example.json'
    ```
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/collator-groups-example.toml'
    ```

=== "JSON"

    ```json title="collator-groups-example.json"
    --8<-- 'code/develop/toolkit/blockchain/spawn-networks/zombienet/configuration/collator-groups-example.json'
    ```
