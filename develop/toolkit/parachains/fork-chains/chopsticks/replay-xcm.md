...
If you have not forked a chain before, see the [Fork a Chain with Chopsticks guide](/tutorials/polkadot-sdk/testing/fork-live-chains/) or [Fork a Network Locally using Chopsticks](https://wiki.polkadot.network/learn/learn-guides-test-opengov-proposals/#fork-a-network-locally-using-chopsticks).
...
Assuming you have the `tx` transaction from the previous step, you can perform a dry run like this:
...
If the dry run is successful, you will see output indicating the XCM would execute without errors:
...
If it fails, you will receive detailed error information:
