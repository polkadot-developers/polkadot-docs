...
--8<-- 'code/develop/toolkit/rollups/e2e-testing/moonwall/init.html'

The wizard generates a `moonwall.config` file:

```json
--8<-- 'code/develop/toolkit/rollups/e2e-testing/moonwall/init-moonwall.config.json'
```
...
```json
--8<-- 'code/develop/toolkit/rollups/e2e-testing/moonwall/moonwall.config.json'
```
...
```ts
--8<-- 'code/develop/toolkit/rollups/e2e-testing/moonwall/test1.ts'
```
...
Example output:
--8<-- 'code/develop/toolkit/rollups/e2e-testing/moonwall/output.html'
