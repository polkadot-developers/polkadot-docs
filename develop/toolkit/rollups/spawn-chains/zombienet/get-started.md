...
- **`test <testFile>`** - run tests on the spawned network using the assertions and tests defined in the [test file](/develop/toolkit/rollups/spawn-chains/zombienet/write-tests/#the-test-file){target=\_blank}
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/base-example.toml'
    ```

=== "JSON"

    ```json title="base-example.json"
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/base-example.json'
    ```
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/relaychain-example-nodes.toml'
    ```

=== "JSON"

    ```json title="relaychain-example-nodes.json"
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/relaychain-example-nodes.json'
    ```
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/relaychain-example-node-groups.toml'
    ```
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/parachain-example.toml'
    ```

=== "JSON"

    ```json title="parachain-example.json"
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/parachain-example.json'
    ```
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/collator-example.toml'
    ```

=== "JSON"

    ```json title="collator-example.json"
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/collator-example.json'
    ```
...
=== "TOML"
    ...
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/collator-groups-example.toml'
    ```

=== "JSON"

    ```json title="collator-groups-example.json"
    --8<-- 'code/develop/toolkit/rollups/spawn-chains/zombienet/get-started/collator-groups-example.json'
    ```
