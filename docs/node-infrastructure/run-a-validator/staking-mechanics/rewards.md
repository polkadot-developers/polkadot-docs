...
This equal split applies to the era-point reward pool shown above. Since Referendum [1909](https://polkadot.subsquare.io/referenda/1909), validators also receive a separate self-stake-based payout that is not split equally. See [Types of Validator Payouts](#types-of-validator-payouts) for details.
