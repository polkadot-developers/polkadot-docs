...
For when to reach for this versus the [Bulletin Chain](/reference/apps/infrastructure/bulletin-chain/) or local storage, see [Where to Store Data](/apps/concepts/data-placement/).
