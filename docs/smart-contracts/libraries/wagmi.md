...
short_description: React hooks for wallet connections and contract calls.
...
??? code "Example Polkadot Hub TestNet Configuration"
    ...
    --8<-- 'code/smart-contracts/libraries/wagmi/wagmi-testnet.ts'
    ```
...
--8<-- 'code/smart-contracts/libraries/wagmi/layout.tsx'
```
...
--8<-- 'code/smart-contracts/libraries/wagmi/ConnectWallet.tsx'
```
...
--8<-- 'code/smart-contracts/libraries/wagmi/BlockchainInfo.tsx'
```
...
--8<-- 'code/smart-contracts/libraries/wagmi/page.tsx'
```
