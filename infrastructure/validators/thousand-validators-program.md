...
nominations at every era for Polkadot, and every four eras for Kusama. The backend does
...
=== "Applying to Polkadot"
    **Entrance to the Polkadot program requires a rank of 100 or higher in the Kusama program.**
    ...
    and fill in the [application form](https://forms.gle/LTCze7fJvqQinPqx6). You will hear back from the team shortly.


=== "Applying to Kusama"
    In order to apply to the Kusama 1KV programme, set up your node to adhere to the requirements below
    and fill in the [application form](https://forms.gle/dZkWrGWCNG3ENVCfA). The process of review and addition is a manual one; you'll be invited to the 1KV Kusama channel and added to the leaderboard, if accepted.
...
===Polkadot
  ...
  - Minimum of 5_000 DOT self stake
...
Within the Kusama program, there are several other nominator accounts that can exhaustively be determined by parsing data found [here](https://kusama.w3f.community/nominators)
