...
- **Docker-based Setup**: Best for simpler set up and maintainance
...
<!--TODO: turn this into tabbed content for the two options-->
=== "Docker-Based Setup"
    ...
    2. (Optional but recommended) Download database snapshots
        ...
        - You can obtain the lastest snapshot from the [Snapshot Provider](https://snapshots.polkadot.io/){target=\_blank}. Follow these steps to download and use snapshots:
...
<!--TODO: double check the "restart the container" command as it looks wrong. Is there supposed to be a "Stop the container" step in here somewhere instead? -->
=== "Docker Setup"
...
=== "systemd Setup"
    ...
    3. Update the binary:
        ```bash
        cargo install --locked --force polkadot-omni-node@<INSERT_NEW_VERSION>
        ```
