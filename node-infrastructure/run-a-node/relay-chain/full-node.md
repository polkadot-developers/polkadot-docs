...
??? interface "macOS"
    ...
    --8<-- 'code/node-infrastructure/run-a-node/full-node/setup-full-node-1.html'
...
??? interface "Linux (compile binary)"
    ...
    --8<-- 'code/node-infrastructure/run-a-node/full-node/setup-full-node-2.html'
...
--8<-- 'code/node-infrastructure/run-a-node/full-node/run-node.html'
