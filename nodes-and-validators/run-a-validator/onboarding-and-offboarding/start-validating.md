...
![Polkadot telemetry dashboard](/images/nodes-and-validators/run-a-validator/onboarding-and-offboarding/start-validating/start-validating-01.webp)
...
![staking queue](/images/nodes-and-validators/run-a-validator/onboarding-and-offboarding/start-validating/start-validating-05.webp)
...
- Confirm your system meets the [requirements](/nodes-and-validators/run-a-validator/){target=\_blank} for running a validator.
