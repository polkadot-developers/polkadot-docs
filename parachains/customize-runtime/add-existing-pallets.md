...
```rust
--8<-- 'code/parachains/customize-runtime/add-existing-pallets/pallet-basic-config-trait.rs'
```
...
```rust
--8<-- 'code/parachains/customize-runtime/add-existing-pallets/utility-pallet-config-trait.rs'
```
...
```rust
--8<-- 'code/parachains/customize-runtime/add-existing-pallets/parameter-types-example.rs'
```
...
```rust
--8<-- 'code/parachains/customize-runtime/add-existing-pallets/impl-pallet-example-in-runtime.rs'
```
...
```rust
--8<-- 'code/parachains/customize-runtime/add-existing-pallets/frame-support-runtime-macro.rs'
```
...
-   <span class="badge guide">Guide</span> __Add Multiple Pallet Instances__
    ...
    [:octicons-arrow-right-24: Reference](/parachains/customize-runtime/add-pallet-instances/)
