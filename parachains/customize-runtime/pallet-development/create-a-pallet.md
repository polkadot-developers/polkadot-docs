...
[:octicons-code-16:](https://github.com/polkadot-developers/polkadot-cookbook/blob/master/polkadot-docs/parachains/customize-runtime/pallet-development/create-a-pallet/tests/guide.test.ts "View the test source for implementation details"){target=\_blank}
{: .verified-tutorial-badges }

!!! verified "Verified Tutorial"
...
!!! verified "This tutorial is verified by automated tests"
    View the [test source](https://github.com/polkadot-developers/polkadot-cookbook/blob/master/polkadot-docs/parachains/customize-runtime/pallet-development/create-a-pallet/tests/guide.test.ts){target=_blank} for implementation details.
