...
2.  Configure the dependencies required for FRAME pallet development in the `Cargo.toml` file as follows:
    ...
    ```toml
    --8<-- 'code/parachains/pallet-development/index/Cargo.toml'
    ```
...
3.  Initialize the pallet structure by replacing the contents of `src/lib.rs` with the following scaffold code:
    ...
    ```rust
    --8<-- 'code/parachains/pallet-development/index/barebone-pallet-template.rs'
    ```
...
```rust
--8<-- 'code/parachains/pallet-development/index/pallet-config.rs'
```
...
```rust
--8<-- 'code/parachains/pallet-development/index/pallet-event.rs'
```
...
```rust
--8<-- 'code/parachains/pallet-development/index/pallet-error.rs'
```
...
```rust
--8<-- 'code/parachains/pallet-development/index/pallet-storage.rs'
```
...
```rust
--8<-- 'code/parachains/pallet-development/index/pallet-call.rs'
```
...
???code
    ```rust
    --8<-- 'code/parachains/pallet-development/index/full-pallet.rs'
    ```
