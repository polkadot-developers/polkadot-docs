...
```rust
--8<-- 'code/parachains/pallet-development/mock-runtime/integration-testing-module.rs'
```
...
```rust
--8<-- 'code/parachains/pallet-development/mock-runtime/mock-runtime.rs'
```
### Genesis Storage
...
```rust
--8<-- 'code/parachains/pallet-development/mock-runtime/genesis-config.rs'
```
...
```rust
--8<-- 'code/parachains/pallet-development/mock-runtime/genesis-config-custom.rs'
```
...
```rust
--8<-- 'code/parachains/pallet-development/mock-runtime/pallets-configurations.rs'
```
...
-   <span class="badge guide">Guide</span> __Pallet Testing__
    ...
    [:octicons-arrow-right-24: Reference](/parachains/pallet-development/pallet-testing/)
