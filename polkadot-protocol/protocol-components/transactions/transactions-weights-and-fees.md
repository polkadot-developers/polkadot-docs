...
```rust
--8<-- 'code/polkadot-protocol/trasactions/transactions-weights-and-fees/default-weight-annotation.rs'
```
...
```rust
--8<-- 'code/polkadot-protocol/trasactions/transactions-weights-and-fees/weight-read-write-annotation.rs'
```
...
```rust
--8<-- 'code/polkadot-protocol/trasactions/transactions-weights-and-fees/normal-dispatch-and-user-is-not-charged.rs'
```
...
```rust
--8<-- 'code/polkadot-protocol/trasactions/transactions-weights-and-fees/dynamic-weights.rs'
```
...
```rust
--8<-- 'code/polkadot-protocol/trasactions/transactions-weights-and-fees/weight-correction.rs'
```
...
```rust
--8<-- 'code/polkadot-protocol/trasactions/transactions-weights-and-fees/custom-fees.rs'
```
...
```rust
--8<-- 'code/polkadot-protocol/trasactions/transactions-weights-and-fees/weight-calculator.rs'
```
...
```rust
--8<-- 'code/polkadot-protocol/trasactions/transactions-weights-and-fees/custom-inclusion-fee.rs'
```
