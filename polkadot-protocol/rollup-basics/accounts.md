...
![Illustration of Lock Example](/images/polkadot-protocol/rollup-basics/accounts/locks-example-2.webp)
...
![](/images/polkadot-protocol/rollup-basics/accounts/account-balance-types-1.webp)
...
--8<-- 'code/polkadot-protocol/rollup-basics/accounts/address-formats-1.html'
...
--8<-- 'code/polkadot-protocol/rollup-basics/accounts/address-formats-2.html'
...
```js
--8<-- 'code/polkadot-protocol/rollup-basics/accounts/address-formats-3.js'
```
