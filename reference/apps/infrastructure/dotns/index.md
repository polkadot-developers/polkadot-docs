...
description: Reference for dotNS — the .dot name system on Asset Hub that resolves Polkadot Product names to published bundles, with PopRules pricing and a contract-based architecture.
...
For the Product-side how-to (registering a name, publishing your bundle), see [Register and Publish](/apps/deploy-and-publish/register-and-publish/){target=\_blank}.
