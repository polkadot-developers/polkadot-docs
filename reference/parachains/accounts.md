...
--8<-- 'code/reference/parachains/accounts/address-formats-1.html'
...
--8<-- 'code/reference/parachains/accounts/address-formats-2.html'
...
```js
--8<-- 'code/reference/parachains/accounts/address-formats-3.js'
```
