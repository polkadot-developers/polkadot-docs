...
```rust
--8<-- 'code/reference/parachains/data-encoding/data-encode-decode.rs'
```
...
- **Solidity**: [`LucasGrasso/solidity-scale-codec`](https://github.com/LucasGrasso/solidity-scale-codec){target=\_blank} _(not audited)_
