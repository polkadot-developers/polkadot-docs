...
--8<-- 'code/reference/tools/moonwall/init.html'

The wizard generates a `moonwall.config` file:

```json
--8<-- 'code/reference/tools/moonwall/init-moonwall.config.json'
```
...
```json
--8<-- 'code/reference/tools/moonwall/moonwall.config.json'
```
...
```ts
--8<-- 'code/reference/tools/moonwall/test1.ts'
```
...
Example output:
--8<-- 'code/reference/tools/moonwall/output.html'
