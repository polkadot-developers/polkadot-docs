...
--8<-- 'code/reference/tools/sidecar/terminal-output.md'
...
```bash
--8<-- 'code/reference/tools/sidecar/get-node-version.md'
```
...
--8<-- 'code/reference/tools/sidecar/asset-hub-node-version-response.md'
