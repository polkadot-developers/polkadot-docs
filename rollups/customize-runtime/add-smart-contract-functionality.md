...
For step-by-step guidance on adding these pallets to your runtime, refer to [Add a Pallet to the Runtime](/rollups/customize-runtime/add-existing-pallets/){target=\_blank}.
...
This pallet enables the deployment and execution of Wasm-based smart contracts on your blockchain. For detailed instructions on adding this pallet to your runtime, see [Add a Pallet to the Runtime](/rollups/customize-runtime/add-existing-pallets/){target=\_blank}.
