...
short_description: Set up Hardhat Polkadot to deploy Solidity contracts using the PVM runtime.
...
page_tests:
  path: polkadot-docs/smart-contracts/dev-environments/hardhat-pvm/tests/docs.test.ts
---
