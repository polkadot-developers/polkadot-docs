...
1. Open the MetaMask extension and click on the network icon to switch to the Polkadot Hub TestNet.
    ...
    ![](/images/smart-contracts/integrations/index/wallets-1.webp){: .browser-extension}
...
4. Click on **Polkadot Hub TestNet** to switch the network.
    ...
    ![](/images/smart-contracts/integrations/index/wallets-4.webp){: .browser-extension}
...
??? code "Polkadot Hub TestNet"
    ...
    ![](/images/smart-contracts/integrations/index/subwallet-PAS.webp){: .browser-extension}
...
2. After setting up your wallet, click the List icon at the top left corner of the extension window to open **Settings**.
    ...
    ![](/images/smart-contracts/integrations/index/subwallet-01.webp){: .browser-extension}

3. Scroll down and select **Manage networks**.

    ![](/images/smart-contracts/integrations/index/subwallet-02.webp){: .browser-extension}
...
2. Once installed, click on the Talisman icon in your browser extensions and click on the **Settings** button.
    ...
    ![](/images/smart-contracts/integrations/index/wallets-5.webp){: .browser-extension}

3. Click the button **All settings**.

    ![](/images/smart-contracts/integrations/index/wallets-6.webp){: .browser-extension}

4. Go to the **Networks & Tokens** section.

    ![](/images/smart-contracts/integrations/index/wallets-7.webp)

5. Click the **Manage networks** button.

    ![](/images/smart-contracts/integrations/index/wallets-8.webp)

6. Click the **+ Add network** button.

    ![](/images/smart-contracts/integrations/index/wallets-9.webp)

7. Fill in the form with the required parameters and click the **Add network** button.

    ![](/images/smart-contracts/integrations/index/wallets-10.webp)
...
8. After that, you can switch to the Polkadot Hub TestNet by clicking on the network icon and selecting **Polkadot Hub TestNet**.
    ...
    ![](/images/smart-contracts/integrations/index/wallets-11.webp)
