...
short_description: Type-safe EVM interactions and utilities.
...
--8<-- 'code/smart-contracts/libraries/viem/chainConfig.ts'
```
...
--8<-- 'code/smart-contracts/libraries/viem/createClient.ts'
```
...
??? code "Fetch Last Block code"
    ...
    --8<-- 'code/smart-contracts/libraries/viem/fetchLastBlock.ts'
    ```
...
--8<-- 'code/smart-contracts/libraries/viem/createWallet.ts'
```
...
--8<-- 'code/smart-contracts/libraries/viem/Storage.sol'
```
...
--8<-- 'code/smart-contracts/libraries/viem/compile.ts'
```
...
--8<-- 'code/smart-contracts/libraries/viem/deploy.ts'
```
...
--8<-- 'code/smart-contracts/libraries/viem/interact.ts'
```
...
-   <span class="badge external">External</span> __Test Frameworks__
    ...
    <li>[:octicons-arrow-right-24: Foundry](https://www.getfoundry.sh/){target=\_blank}</li>
    </ul>
