...
--8<-- 'code/tutorials/blockchains/testing/spawn-basic-chain/spawn-a-basic-network.toml'
```
...
--8<-- 'code/tutorials/blockchains/testing/spawn-basic-chain/spawn-network-terminal-01.html'
...
![](/images/tutorials/blockchains/testing/spawn-basic-chain/spawn-basic-network-01.webp)
