...
In this tutorial, you'll learn how to replay and dry-run XCMs using [Chopsticks](/parachains/testing/){target=\_blank}, a powerful tool for forking live Polkadot SDK-based chains in your local environment. These techniques are essential for:
...
- [Chopsticks](/parachains/testing/){target=\_blank} installed (`npm i -g @acala-network/chopsticks`).
...
-   <span class="badge guide">Guide</span> __Polkadot XCM Docs__
    ...
    [:octicons-arrow-right-24: Get Started](/parachains/interoperability/)
