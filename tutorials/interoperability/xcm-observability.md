...
flowchart LR
    ...
    subgraph Line2
        E[XCM forwarded to Destination Chains]
        F[Destination Chain executes XCM]
        G[MessageQueue.Processed event emitted with matching id]
        H[Success or failure logged; further hops if any]
    end
