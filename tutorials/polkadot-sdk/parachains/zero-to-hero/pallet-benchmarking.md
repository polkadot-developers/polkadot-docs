...
3. Add your pallet to the runtime's benchmark configuration:
    ...
    1.  Register your pallet in `runtime/src/benchmarks.rs`:
        ...
        --8<-- 'code/parachains/customize-runtime/pallet-development/add-pallet-to-runtime/src/benchmarks.rs:26:37'
        ```
...
--8<-- 'code/parachains/customize-runtime/pallet-development/add-pallet-to-runtime/src/configs/mod.rs:333:338'
```
