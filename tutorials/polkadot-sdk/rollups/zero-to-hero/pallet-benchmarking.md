...
After validating your pallet through testing and integrating it into your runtime, the next crucial step is benchmarking. Testing procedures were detailed in the [Pallet Unit Testing](/tutorials/polkadot-sdk/rollups/zero-to-hero/pallet-unit-testing/){target=\_blank} tutorial, while runtime integration was covered in the [Add Pallets to the Runtime](/tutorials/polkadot-sdk/rollups/zero-to-hero/add-pallets-to-runtime/){target=\_blank} guide.
...
For comprehensive information about benchmarking concepts, refer to the [Benchmarking](/develop/rollups/testing/benchmarking/){target=\_blank} guide.
...
2. Update your pallet's `Cargo.toml` file in the `pallets/custom-pallet` directory with the following modifications:
    1. Add the [`frame-benchmarking`](https://docs.rs/frame-benchmarking/latest/frame_benchmarking/){target=\_blank} dependency:
        ...
        ...
        --8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/Cargo.toml:15:15'
        ```

    2. Enable benchmarking in the `std` features:
        ```toml hl_lines="6" title="Cargo.toml"
        --8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/Cargo.toml:24:30'
        ```

    3. Add the `runtime-benchmarks` feature flag:
        ```toml hl_lines="3-8" title="Cargo.toml"
        --8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/Cargo.toml:22:22'
        ...
        --8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/Cargo.toml:31:36'
        ```
...
3. Add your pallet to the runtime's benchmark configuration:
    1.  Register your pallet in `runtime/src/benchmarks.rs`:
        ...
        --8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/runtime/src/benchmarks.rs:26:37'
        ```

    2. Enable runtime benchmarking for your pallet in `runtime/Cargo.toml`:
        ```toml hl_lines="3" title="Cargo.toml"
        --8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/runtime/Cargo.toml:136:136'
          ...
        --8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/runtime/Cargo.toml:160:161'
        ```
...
4. Set up the benchmarking module in your pallet:
    ...
    2. Add the benchmarking module to your pallet. In the pallet `lib.rs` file add the following:
        ...
        --8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/src/lib.rs:21:32'
        ```
...
```rust
--8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/src/benchmarking.rs:41:55'
```
...
--8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/src/benchmarking.rs:20'
```
...
--8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/src/lib.rs:30:34'
```
...
--8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/src/lib.rs:45:57'
```
...
--8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/src/lib.rs:116:133'
```
...
--8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/pallets/custom-pallet/src/mock.rs:60:64'
```
...
--8<-- 'code/tutorials/polkadot-sdk/rollups/zero-to-hero/runtime/src/configs/mod.rs:327:332'
```
...
-   <span class="badge tutorial">Tutorial</span> __Deploy on Paseo TestNet__
    ...
    [:octicons-arrow-right-24: Get Started](/tutorials/polkadot-sdk/rollups/zero-to-hero/deploy-to-testnet/)
